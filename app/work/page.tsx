...
const projects = [
  {
    ...
    live: "",
    github: "https://github.com/guidounion6/Proyecto-Individual-Countries",
  },
  {
    num: "02",
    category: "Backend",
    ...
    >
      <div className="container mx-auto">Projects
        <div className="flex flex-col xl:flex-row xl:gap-[30px] ">
          <div className="w-full xl:w-[50%] xl:h-[460px] flex flex-col sl:justify-between order-2 xl:order-none">
          ...
          <div className="w-full xl:w-[50%]">
            <Swiper spaceBetween={30} slidesPerView={1} className="hl:h-[520px] mb-12" onSlideChange={handleSlideChange}>
